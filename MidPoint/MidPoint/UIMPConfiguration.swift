...
class UIMPConfiguration {
    ...
    class func customTabBar(view: UINavigationBar){
        view.tintColor = Colors.Azul
        view.translucent = false
        view.titleTextAttributes = [NSAttributedString() : Colors.Branco]
        
        view.barTintColor = Colors.Azul
        view.titleTextAttributes = [NSForegroundColorAttributeName : Colors.Branco]
        view.tintColor = Colors.Branco
